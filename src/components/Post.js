  ...
  return (
    <main className=' min-h-screen p-12'>
      <section className='container mx-auto'>
        <h1 className='text-5xl text-purple-600 flex justify-center cursive'>
          Blog Posts
        </h1>
        <h2 className='text-lg text-purple-600 flex justify-center mb-12'>
          Welcome to the blog page of posts
        </h2>
